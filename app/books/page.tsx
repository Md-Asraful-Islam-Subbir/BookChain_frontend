    ...
    return (
        <div className='min-h-screen bg-gray-100'>
            <div className='container mx-auto px-4 py-8'>
                ...
                <h1 className='mb-8 text-3xl font-bold'>{" "}Find from 100th of used books online{" "}</h1>
                                ...
                                <div className='flex justify-between'>
                                    ...
                                    <Select value={sortOption} onValueChange={setSortOption}>
                                        ...
                                        <SelectContent position="popper"
                                            ...
                                            <SelectItem value='oldest'>Olddest First</SelectItem>
                                    ...
                                    {paginatedBooks.map((book) => (
                                        ...
                                        >
                                            <Card className="group relative overflow-hidden rounded-lg transition-shadow duration-300 hover:shadow-2xl bg-white border-0">
                                                    ...
                                                    <Link href={`/books/${book._id}`}>
                                                        <div className="relative">
                                                            <img
                                                                ...
                                                                width={400}
                                                                height={300}
                                                                className="h-62.5 w-full object-cover transition-transform duration-300 group-hover:scale-105"
                                                            />
                                                            ...
                                                            <Button size='icon' variant='ghost' className='right-2 top-2 absolute h-8 w-8 rounded-full bg-white/80 backdrop-blur-sm transition-opacity duration-300 hover:bg-white group-hover:opacity-100'>
                                                        ...
                                                        <div className='p-4 space-y-2'>
                                                            ...
                                                            <div className='flex items-baseline gap-2'>
                                                                <span className='text-2xl font-bold text-black'>৳{book.finalPrice}</span>
                                                                {
                                                                    book.price && (
                                                                        <span className='text-sm text-zinc-500 line-through'>৳{book.price}</span>
                                                                    )
                                                                }
                                                            </div>
                                                ...
                                                <div className='absolute -left-8 -bottom-8 h-24 w-24 rounded-full bg-orange-500/10 blur-2xl' />
