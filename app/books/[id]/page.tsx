            ...
            <div className='container mx-auto px-4 py-8'>
                ...
                <div className='grid gap-8 md:grid-cols-2'>
                    <div className='space-y-4'>
                        <div className='relative h-100 overflow-hidden rounded-lg border bg-white shadow-md'>
                        ...
                        <div className='flex gap-2 overflow-x-auto py-2'>
                            {bookImage.map((images, index) => (
                                <button
                                    ...
                                    className={`relative h-16 w-16 shrink-0 overflow-hidden rounded-lg border transition-all duration-200 ${selectedImage === index ? "ring-2 ring-primary scale-105" : "hover:scale-105"}`}
                                >
                                    <Image
                                        src={images}
                            ...
                            <Button className='w-60 py-6 bg-blue-700'>
                                {
                                    isAddToCart ? (
                                        <>
                                            <Loader2 className='animate-spin mr-2' size={20} /> Adding to Cart...
                                        </>
                                    ) :
                                        <>
                            ...
                            <Card className='border border-gray-200 shadow-sm p-6'>
                                ...
                                <CardContent className='grid gap-4'>
                                    <div className='grid grid-cols-2 gap-4 text-sm'>
                                        <div className='font-medium text-muted-foreground'>Subject/Tittle</div>
                ...
                <div className='mt-8 grid gap-8 md:grid-cols-2'>
                    <Card className='border-none shadow-md p-6'>
                        ...
                        <CardContent className='space-y-4'>
                            ...
                            <div className='border-t pt-4'>
                                ...
                                <p className='text-muted-foreground'>We're not just another shopping website where you buy from professional sellers - we are a vibrant community of students, book lovers across Bangladesh who deliver happiness to each other!</p>
                            </div>
                    ...
                    <Card className='border-none shadow-md p-6'>
                        <CardHeader>
                            <CardTitle className='text-lg'>Sell By:</CardTitle>
                        </CardHeader>
                        <CardContent className='space-y-4'>
                            <div className='flex items-center justify-between'>
                    ...
                    <div className='grid gap-8 md:grid-cols-3'>
                        {
                            [{
                                ...
                                description:
                                    "Seller posts an ad on book chain to sell their used books.",
