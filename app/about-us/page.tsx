    ...
    <div className="min-h-screen bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-600 text-lg text-center mb-12">
          Welcome to BookChain, your ultimate destination for buying and selling
          used books online.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8 transition-transform transform hover:scale-105">
            ...
            <p className="text-gray-600 text-center">
              At BookChain, we aim to make reading accessible to everyone by
        ...
        <div className="mt-16 flex flex-col md:flex-row gap-4 items-center mb-4">
          <img
            ...
            alt="Books"
            className="w-full md:w-150 rounded-lg shadow-md mb-4 md:mb-0"
          />
          <img
            src="/images/book2.jpg"
            alt="Reading"
            className="w-full md:w-150 rounded-lg shadow-md"
          />
        </div>
        <h2 className="text-xl font-semibold text-center mb-4">
          Join Us Today!
