...
const StatusStep = ({
  ...
  return (
    <div
      className={`flex flex-col items-center ${isCompleted
        ? 'text-green-500'
        : isActive
          ? 'text-blue-500'
          : 'text-gray-400'
        ...
        <div className="space-y-6">
          <div className="bg-linear-to-r from-purple-100 to-pink-100 p-4 rounded-lg">
            ...
            <div className="flex justify-between items-center">
              ...
              <StatusStep
                title='delivered' icon={<CheckCircle className='h-5 w-5' />}
              ...
              {order?.items?.map((item, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className='text-medium text-gray-500'>Quantity: {item.quantity}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="bg-linear-to-r from-yellow-100 to-orange-100 p-4 rounded-lg">
            <h3 className="font-serif text-lg text-orange-800 mb-2">
              Payment Details
            </h3>
