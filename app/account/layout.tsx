...
const layout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        <div className='grid p-4 w-[90%] mx-auto lg:grid-cols-[370px_1fr]'>
            <div className='hidden border-r mr-5 rounded-lg p-2 bg-linear-to-b from-violet-500 to-purple-700 lg:block'>
                                ...
                                {navigation.map((item) => {
                                    ...
                                    return (
                                        <Link
                                            key={item.href}
                                            href={item.href}
                                            className={`flex items-center gap-3 rounded-lg px-3 py-3 mb-2 transition-all ${isActive ? `bg-linear-to-r ${item.color} text-white` : 'text-purple-100 hover:bg-purple-600'}`}
                                        >
