    ...
    const MenuItems = ({ className = " " }) => (
        <div className={className}>
            {menuItems.map((item, index) =>
                item?.href ? (
                    <Link key={index} href={item.href} className='flex items-center gap-3 px-4 py-3 text-sm rounded-lg hover:bg-gray-200'
                    ...
                    <button key={index} className='flex w-full items-center gap-3 px-4 py-3 text-sm rounded-lg hover:bg-gray-200'
